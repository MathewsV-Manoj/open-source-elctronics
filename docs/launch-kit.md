...
2. Use the code **`opencircuit`**, so your dashboard is at `opencircuit.goatcounter.com`. The site already sends visits there.
...
Paste the site link into https://www.linkedin.com/post-inspector/ to check the preview image. LinkedIn caches previews, so this also refreshes it.

---

## 2. LinkedIn launch post

Attach a 30–45 second screen recording: the home page, a simulator being used (logic gates or PWM), the projects page, then the certificate.

> I'm a second-year ECE student at MITS, and I kept seeing friends struggle with electronics. The textbooks jump straight into equations, and the "why" gets lost.
>
> So I built **OpenCircuit Academy**, a free course that explains electronics the way I wish it had been explained to me:
>
> ⚡ 9 modules, from "what is voltage?" to Arduino, ESP32, Raspberry Pi, embedded systems and VLSI
> 🎛️ 18 simulators you can play with right in the browser
> 🛠️ 23 projects with parts lists, wiring and code, from a 555 flasher to face detection on a Raspberry Pi
> 🎓 Notes linking every topic to the GATE ECE syllabus
> 📜 A free certificate at the end
>
...
>
> #electronics #embeddedsystems #arduino #ECE #GATE #studentproject #opensource

Tag: Muthoot Institute of Technology and Science, IEEE Kerala Section, and your faculty (with permission).
...
## 4. Message to faculty or the IEEE / IEDC coordinator
...
>
> Regards,
> Mathews V Manoj, second-year ECE

---

## 5. Reddit (r/arduino, r/esp32, r/embedded, r/ECE)

Read each community's self-promotion rules first. Post as a request for feedback, not an advert.

**Title:** I'm an ECE student and built a free interactive electronics course with in-browser simulators. Feedback welcome
...
**Title:** `Show HN: OpenCircuit – a free interactive electronics course with in-browser simulators`
**URL:** the site link. Then add a first comment explaining why you built it and asking for feedback.
...
| Week | Do this |
|------|---------|
| 1 | Set up section 1. LinkedIn launch post. WhatsApp groups. Message faculty and IEEE/IEDC. |
| 2 | Two short videos (Reels/Shorts) of simulators: logic gates, PWM. One LinkedIn post: "Ohm's law explained with a water tank". |
| 3 | Reddit posts (one community per day). Plan a free Arduino workshop at MITS. |
| 4 | Show HN. LinkedIn post sharing what you learned and the first visitor numbers from GoatCounter. |

After that: one LinkedIn post a week, taken from a lesson. There are 42 lessons of ready-made material.
